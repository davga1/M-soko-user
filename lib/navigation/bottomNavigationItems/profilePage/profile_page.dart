      ...
      children: [
        ...
        Row(
          children: [
            ...
            const SizedBox(width: 5),
            Text(UserDataService().userModel?.email ?? 'No email'),
          ],
        ),
      ...
      children: [
        ...
        Row(
          children: [
            const Icon(CupertinoIcons.device_phone_portrait),
            const SizedBox(width: 5),
            Text(UserDataService().userModel?.mobile.toString() ?? 'no mobile'),
          ],
        ),
        const SizedBox(height: 3),
        Row(
        ...
        const SizedBox(height: 10),
        Text(
            '${UserDataService().userModel?.city ?? 'no city'} ${UserDataService().userModel?.pin ?? 'no pin'}'),
        const SizedBox(height: 5),
        Text(
            '${UserDataService().userModel?.state ?? 'no state'}, ${UserDataService().userModel?.country ?? 'no country'}'),
        const SizedBox(height: 25),
      ],
    );
  }
