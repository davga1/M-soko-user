...
class _ChatListScreenState extends State<ChatListScreen> {
  final String currentUserId = UserDataService().userModel?.uid.toString() ?? 'No text';
  final String currentUserEmail = UserDataService().userModel?.email.toString() ?? 'No text';
  @override
